  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden aspect-square bg-ivory">
        <div
          className="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-108"
          style={{ backgroundImage: `url(${product.images[0]})` }}
        />
        {product.originalPrice && (
          <div
            className="absolute top-3 left-3 badge badge-saffron"
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-center gap-2 mt-1 pt-2" style={{ borderTop: "1px solid rgba(209, 168, 110, 0.15)" }}>
          <span
            className="font-bold"
            style={{ color: "var(--color-midnight)", fontFamily: "var(--font-body)", fontSize: "1rem" }}
          >
          ...
          {product.originalPrice && (
            <span
              ...
              style={{ color: "rgba(45, 41, 38, 0.4)", fontFamily: "var(--font-body)" }}
            >
